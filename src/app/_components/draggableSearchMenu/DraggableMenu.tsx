...
export default function DraggableMenu() {
  ...
  return (
    <div ref={constraintsRef} className={'fixed top-0 left-0 h-[100dvh] w-[100dvw] pointer-events-none'}>
      ...
      >
        <div className={'flex gap-5'}>
          <article
            ...
            className={classNames('pointer-events-auto hover:cursor-pointer', isDragging && 'hover:cursor-grab')}
          >
            <MonsterBall />
          </article>
        </div>
